...
cupHeight = 0.2; %Define dimensions for the cup.
cupRadius = 0.05; 
cupPosition = [-0.5, 0.5, cupHeight/2];
body = rigidBody('cupFrame'); %Add a fixed body to the robot model representing the center of the cup.
...
%Create a Cartesian bounds constraint that requires the gripper to be at least 5 cm above the table (negative z direction)
